...
fn act2_rule_index() -> HashMap<CellType, Vec<Rule>> {
    ...
    for acc in 0..ACC_MOD {
        ...
        rules.push(Rule {
            ...
            active_only: false, priority: 10, min_age: QUIET2, overflow: Default::default(), cam: None, tie_break: 0, starvation_after: None, feedback: None, recursion: None, memory: None, max_activations: None,
        });
