...
mod tests {
    ...
    fn test_tm_translator_bit_invert_4bit() {
        ...
        let mut grid = make_grid(16, 1);
        grid.set_cell(0, 0, Cell { value: CellValue(CellType::new(10)), age: 0 });
        grid.set_cell(1, 0, Cell { value: CellValue(CellType::new(1)), age: 0 });
        grid.set_cell(2, 0, Cell { value: CellValue(CellType::new(1)), age: 0 });
        grid.set_cell(3, 0, Cell { value: CellValue(CellType::new(2)), age: 0 });
        grid.set_cell(4, 0, Cell { value: CellValue(CellType::new(2)), age: 0 });
